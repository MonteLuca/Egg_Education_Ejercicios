...
import Persona2.Servicios.Persona2Servicios;
/**
 * @author Luca Monte
 */
public class Ejercicio12_POO_Egg {

    public static void main(String[] args) {
        
        Persona2Servicios ps2 = new Persona2Servicios();
        
        Persona2 persona = ps2.crearPersona();
        
        ps2.calcularEdad(persona);
        
        ps2.menorQue(persona);
        
        ps2.mostrarPersona(persona);
